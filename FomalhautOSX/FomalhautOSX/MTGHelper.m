...
- (BOOL)isEqual:(id)anObject {
    return [anObject isKindOfClass:[MTGHelper class]] && [self.applicationIdentifier isEqualToString:((MTGHelper *)anObject).applicationIdentifier];
}
