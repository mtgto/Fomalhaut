...
@interface MTSmartBookmarkWindowController ()

@property (strong) IBOutlet NSObjectController *bookmarkController;

@end

@implementation MTSmartBookmarkWindowController

- (id)init
{
    return [super initWithWindowNibName:@"MTSmartBookmarkWindowController"];
}
