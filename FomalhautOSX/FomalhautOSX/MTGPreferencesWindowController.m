...
#import "MTGPreferencesWindowController.h"
#import "MTGHelpersController.h"
#import "MTGHelper.h"
...
@interface MTGPreferencesWindowController ()

@property (strong) IBOutlet MTGHelpersController *helpersController;
@property (weak) IBOutlet NSTableView *helperTableView;

@end

@implementation MTGPreferencesWindowController

- (id)init
{
    return [super initWithWindowNibName:@"MTGPreferencesWindowController"];
}
...
- (void)windowDidLoad
{
    ...
    NSArray *helpers = [[[[NSUserDefaultsController sharedUserDefaultsController] values] valueForKey:FILE_VIEW_HELPER_CONFIG_KEY] mapWithBlocks:^id(id obj) {
        return [[MTGHelper alloc] initWithApplicationIdentifier:obj];
    }];
