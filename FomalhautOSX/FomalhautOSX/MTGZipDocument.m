...
- (NSArray *)getPages {
    ...
    self.entries = [[self.archive.entries withFilterBlock:^BOOL(id obj) {
        ...
        ZZArchiveEntry *entry = (ZZArchiveEntry *)obj;
        return [[MTGZipEntryPage alloc] initWithZipEntry:entry];
    }] sortedArrayUsingComparator:^NSComparisonResult(id obj1, id obj2) {
        MTGZipEntryPage *page1 = (MTGZipEntryPage *)obj1;
        MTGZipEntryPage *page2 = (MTGZipEntryPage *)obj2;
