...
@interface MTGOSXAppDelegate()
@property (strong) MTGOSXMainWindowController *mainWindowController;
@property (strong) MTGAcknowledgementWindowController *acknowledgementWindowController;
@end
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    self.mainWindowController = [[MTGOSXMainWindowController alloc] initWithWindowNibName:@"MTGOSXMainWindowController"];
...
- (IBAction)showAcknowledgements:(id)sender {
    self.acknowledgementWindowController = [[MTGAcknowledgementWindowController alloc] initWithWindowNibName:@"MTAcknowledgementWindowController"];
