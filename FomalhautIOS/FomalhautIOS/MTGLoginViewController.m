...
#import "MTGLoginViewController.h"
...
@interface MTGLoginViewController ()
...
@implementation MTGLoginViewController
...
- (IBAction)pushDone:(id)sender {
    ...
    MTGAuthorizationResponseSerializer *serializer = [MTGAuthorizationResponseSerializer serializer];
    ...
    [manager POST:[url absoluteString]
       parameters:params
          success:^(NSURLSessionDataTask *task, id responseObject) {
              if (responseObject) {
                  if ([responseObject isKindOfClass:[MTGAuthorization class]]) {
                      MTGAuthorization *auth = (MTGAuthorization *)responseObject;
                  ...
                  } else if ([responseObject isKindOfClass:[MTGAuthorizationFailure class]]) {
                      // "need a secret"
