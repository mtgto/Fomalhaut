...
@implementation MTGBookListResponseSerializer
...
- (id)responseObjectForResponse:(NSURLResponse *)response data:(NSData *)data error:(NSError *__autoreleasing *)error {
    ...
    if (((NSHTTPURLResponse *)response).statusCode == 200 && [responseObject isKindOfClass:[NSDictionary class]]) {
        return [responseObject[@"books"] mapWithBlocks:^id(id obj) {
            NSDictionary *dict = (NSDictionary *)obj;
            return [MTGBook bookWithUUID:[[NSUUID alloc] initWithUUIDString:dict[@"uuid"]] name:dict[@"name"]];
        }];
    }
    ...
    NSString *localizedDescription = [NSString stringWithFormat:NSLocalizedString(@"ALERT_ERROR_FAILED_TO_LOAD_BOOK_LIST_MESSAGE_FORMAT", nil), errorMessage];
